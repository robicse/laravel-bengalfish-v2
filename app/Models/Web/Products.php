...
class Products extends Model
{
    ...
    public function productCategories1(){
        ...
        if($categories){
            ...
            foreach($categories as $parents){
                ...
                $cat = 'shop?category='.$parents->categories_name;
                $ul .= '<li class="nav-item dropdown '.$dropright.'"><a class="nav-link" href="'.$cat.'" >
    ...
    private function childcat1($childs, $i, $parent_id){
        ...
        foreach($childs as $key => $child){
            ...
            $cat = 'shop?category='.$child->categories_name;
	...
	public function products($data){
        ...
        if($type=="atoz"){
            ...
            // custom by robi
            //$sortby = "products.position_sequence";
            //$order = "asc";
        }
  ...
  //      die("products_id:  $products_id ::: language_id=".Session::get('language_id'));
        /*
        echo"<script type='text/javascript'>
alert('products_id:  $products_id ::: language_id=".Session::get('language_id').");
</script>";
*/
