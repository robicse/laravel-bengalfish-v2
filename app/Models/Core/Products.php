...
class Products extends Model
{
  ...
  public function insert($request){
    ...
    $products_id = DB::table('products')->insertGetId([
        ...
        'position_sequence' => $request->position_sequence,
    ...
    foreach($result['languages'] as $languages_data){
      $description = DB::table('products_description')
        ...
        if(count($description)>0){
            ...
            $description_data[$languages_data->languages_id]['meta_title'] = $description[0]->meta_title;
            $description_data[$languages_data->languages_id]['meta_description'] = $description[0]->meta_description;
        }else{
            ...
            $description_data[$languages_data->languages_id]['meta_title'] = '';
            $description_data[$languages_data->languages_id]['meta_description'] = '';
        }
  ...
  public function updaterecord($request){
          ...
          foreach($languages as $languages_data){
              ...
              if(count($checkExist)>0){
                  ...
                  $req_products_url = $request->$products_url;
                  $req_products_description = $request->$products_description;
                  $req_meta_title = $request->$meta_title;
                  $req_meta_description = $request->$meta_description;
                  ...
                  ->where('language_id', '=', $languages_data->languages_id)->update([
                      ...
                      'meta_description' => $req_meta_description,
                  ]);
              }else{
                  $req_products_name = $request->$products_name;
                  $req_products_url = $request->$products_url;
  ...
  public function ajax_attr($id){
    ...
    public function ajax_get_products($id){
	    //echo $id;die();
        $language_id      =   '1';
        return $product = DB::table('products_description')
            ->join('products_to_categories','products_description.products_id','=','products_to_categories.products_id')
  ...
  public function addnewstock($request){
    ...
    $inventory_ref_id = DB::table('inventory')->insertGetId([
        ...
        //'reference_code' => '456bab6c-61db-4763-9051-9a5c26f8a207',
        'stock' => $request->stock,
