...
class Categories extends Model
{
    ...
    public function insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status,$position_sequence,$meta_title,$meta_description,$cat_slogan,$cat_description){
    ...
    public function updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$position_sequence,$meta_title,$meta_description,$cat_slogan,$cat_description){
    ...
    public function editsubcategory($request){
        $editSubCategory = DB::table('categories')
            ...
            'categories.categories_slug as slug', 'categories.categories_status  as categories_status', 'categories.parent_id as parent_id','categoryTable.path as imgpath','iconTable.path as iconpath','categories.position_sequence','categories.meta_title','categories.meta_description','categories.cat_slogan','categories.cat_description')
            ->where('categories.categories_id', $request->id)->get();
    ...
    public function category_list($language_id){
        $listingCategories = DB::table('categories')
            ->leftJoin('categories_description','categories_description.categories_id', '=', 'categories.categories_id')
            ->select('categories.categories_id as id', 'categories.categories_image as image',  'categories.created_at as date_added', 'categories.updated_at as last_modified', 'categories_description.categories_name as name', 'categories.categories_slug as slug')
            //->where('parent_id','>', '0')
