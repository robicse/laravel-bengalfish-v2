...
class CategoriesController extends Controller
{
  ...
  public function insert(Request $request){
        ...
        $cat_slogan  = $request->cat_slogan;
        $cat_description  = $request->cat_description;

        $categories_id = $this->Categories->insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status,$position_sequence,$meta_title,$meta_description,$cat_slogan,$cat_description);
        $slug_flag = false;
  ...
  //  dd($editSubCategory[0]->parent_id);
   ...
   public function update(Request $request){
     ...
     $updateCategory = $this->Categories->updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$position_sequence,$meta_title,$meta_description,$cat_slogan,$cat_description);
