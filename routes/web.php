...
Route::group(['namespace' => 'Web','middleware' => $middleware], function () {
    ...
    Route::get('/check_search', 'ProductsController@check_search');
    Route::get('/shop/category/{category}', 'ProductsController@shop');
    Route::get('/shop/search/{search}', 'ProductsController@shop');
    Route::get('/shop/category/{category}/search/{search}', 'ProductsController@shop');
    ...
    Route::post('/processPasswordPhone', 'CustomersController@processPasswordPhone');
