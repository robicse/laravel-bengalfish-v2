                  ...
                  <span class="featured-tag">
                    ...
                    <article style="height: ">
                      ...
                      <div class="module">
                        ...
                        <h2 class="title">
                            <a style="color: #2c3941;text-decoration: none" href="{{ URL::to('/product-detail/'.$products->products_slug)}}">
                                {{strtoupper($products->products_name)}}
                            </a>
                        </h2>
                          <h6>{{ $products->products_weight ? $products->products_weight : '' }} {{ $products->products_weight_unit ? $products->products_weight_unit : '' }}</h6>
