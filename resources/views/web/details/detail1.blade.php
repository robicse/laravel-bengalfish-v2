@section('dynamic_title')
    @php
        ...
        $language_id = $result['detail']['product_data'][0]->language_id;
        $prduct_description =  \Illuminate\Support\Facades\DB::table('products_description')->where('products_id',$products_id)->where('language_id',$language_id)->first();
        /*echo '<pre>';
        print_r($prduct_description);
        echo '</pre>';
        die();*/
    @endphp
            ...
            <div class="col-12 col-sm-12 mb-3">
              <div class="row">
                    ...
                    <div class="col-12 col-lg-7" >
                        ...
                        <h1 style="font-size: 38px;font-weight: bold;font-family: 'Roboto Condensed'">{{$result['detail']['product_data'][0]->products_name}}</h1>
                        <span class="tag">
                            {{ $result['detail']['product_data'][0]->products_weight ? $result['detail']['product_data'][0]->products_weight : '' }} {{ $result['detail']['product_data'][0]->products_weight_unit ? $result['detail']['product_data'][0]->products_weight_unit : '' }}
                        </span>
                        <div class="list-main">
                            ...
                            <ul class="list">
                              @if(!empty($result['category_name']) and !empty($result['sub_category_name']))
                                <li style="font-family: 'Roboto Condensed';">{{$result['sub_category_name']}}</li>
                              @elseif(!empty($result['category_name']) and empty($result['sub_category_name']))
                                <li style="font-family: 'Roboto Condensed';">{{$result['category_name']}}</li>
                              @endif
                                <li style="font-family: 'Roboto Condensed';"> {{$result['detail']['product_data'][0]->products_ordered}}&nbsp;@lang('website.Order(s)')</li>
                                @if($result['detail']['product_data'][0]->products_type == 0)
                                @if($result['detail']['product_data'][0]->defaultStock == 0)
                                <li style="font-family: 'Roboto Condensed';" class="outstock"><i class="fas fa-check"></i>@lang('website.Out of Stock')</li>
                                @else
                                <li style="font-family: 'Roboto Condensed';" class="instock"><i class="fas fa-check"></i>@lang('website.In stock')</li>
                                @endif
                                @endif
                            </ul>
                        </div>
...
{{--                                      <label>Quantity</label>--}}
                        ...
                        <div class="product-buttons">
                            <h2 style="font-family: 'Roboto Condensed'" class="mb-1">Total Price:
                              ...
                              @if($result['detail']['product_data'][0]->products_min_order>0)
                                <p style="font-family: 'Roboto Condensed'" class="mb-3">
...
{{--            </div>--}}
              ...
              <div class="col-md-12">
                  <div class="heading">
                      <h2>@lang('website.Related Products')</h2>
                  </div>
                  <div class="tab-content">
