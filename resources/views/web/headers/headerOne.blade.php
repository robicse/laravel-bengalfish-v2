        ...
        <div class="row align-items-center">
             <div class="col-12 col-lg-5">
                 <ul class="fm-top-contact-list">
                    <li><i class="fas fa-phone"></i> <span>09613 850 850, +8801511-262414</span>
                    </li>
             ...
             <div class="col-12 col-lg-4">
                 <ul class="fm-top-middle-menu">
                    <li><a href="https://bengalfish.com.bd/">Home |</a>  </li>
                    <li><a href="https://bengalfish.com.bd/shop">Shop | </a> </li>
                                    ...
                                    <ul class="shopping-cart-items">
                                        ...
                                        <li>
                                            ...
                                            <div class="item-detail">
                                              <h2 class="item-name" style="font-family: 'Roboto Condensed'">{{strtoupper($cart_data->products_name)}}</h2>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        @if(!empty($specific_categories))
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('shop/category').'/'.$specific_category->slug}}">{{ $specific_category->categories_name }}</a>
                            </li>
                            @endforeach
                        @endif
                    </ul>
