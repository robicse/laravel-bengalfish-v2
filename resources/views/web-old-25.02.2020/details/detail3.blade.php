<section class="product-page product-page-three ">
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-12">
            <div class="row">
              ...
              <div class="col-12 col-lg-6 product-page-one">
                      ...
                      <div class="tab-content">
                        ...
                        <form id="idForm">
                             {{csrf_field()}}
                              <div class="tabs-pera">
                                <div class="container">
                                  <div class="feedback" style="margin-left: 85px">
                                    <div class="rating">
                                  ...
                                  <div class="form-group" style="width:100%; padding:0;">
                                    ...
                                    <button class="btn btn-block btn-secondary" type="submit" >Here We GO!</button>
                                    @else
