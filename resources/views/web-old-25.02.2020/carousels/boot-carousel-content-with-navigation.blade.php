      ...
      <div class="col-12 col-lg-9 padding-l0">
          <div id="carouselExampleIndicators3" class="carousel slide" data-ride="carousel">
              <ol class="carousel-indicators">
                ...
                <li data-target="#carouselExampleIndicators3" data-slide-to="{{ $key }}" class="@if($key==0) active @endif"></li>
                @endforeach
              </ol>
              <div class="carousel-inner">
                @foreach($result['slides'] as $key=>$slides_data)
                  ...
                  @endif -->
                  <img class="d-block w-100" src="{{asset('').$slides_data->path}}" alt="First slide">
                <!-- </a> -->
              </div>
            @endforeach
              </div>
