...
Plot No 03, Road No 03, Block B, Dhaka Uddan Housing, Mohammedpur, Dhaka.</span> </li>
              {{--<li> <i class="fas fa-phone"></i><span>({{$result['commonContent']['setting'][11]->value}})</span> </li>--}}
              <li> <i class="fas fa-phone"></i><span>+8801841262414, +8801511-262414</span> </li>
              ...
              <div class="row align-items-center">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="footer-info">
                        © @lang('website.Copy Rights').  <a href="{{url('/page?name=refund-policy')}}">@lang('website.Privacy')</a>&nbsp;&bull;&nbsp;<a href="term.html">@lang('website.Terms')</a>
                    </div>
