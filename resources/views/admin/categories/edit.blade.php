                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Position Sequence </label>
                                            <div class="col-sm-10 col-md-4">
                                                <input type="number" class="form-control" name="position_sequence" id="position_sequence" value="{{ $result['editSubCategory'][0]->position_sequence }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <input type="text" class="form-control" name="meta_title" id="meta_title" value="{{ $result['editSubCategory'][0]->meta_title }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <textarea class="form-control" name="meta_description" id="meta_description">{{ $result['editSubCategory'][0]->meta_description }}</textarea>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="cat_slogan" class="col-sm-2 col-md-3 control-label">Slogan</label>
                                            <div class="col-sm-10 col-md-4">
                                                <textarea class="form-control" name="cat_slogan" id="cat_slogan">{{ $result['editSubCategory'][0]->cat_slogan }}</textarea>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Cat Description</label>
                                            <div class="col-sm-10 col-md-4">
                                                <textarea id="editor" name="cat_description" class="form-control" rows="5">{{ $result['editSubCategory'][0]->cat_description }}</textarea>
                                            </div>
                                        </div>
