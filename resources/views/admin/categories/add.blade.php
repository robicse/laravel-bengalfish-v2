                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <input type="number" class="form-control" name="position_sequence" id="position_sequence">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <textarea class="form-control" name="cat_slogan" id="cat_slogan"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <textarea id="editor" name="cat_description" class="form-control" rows="5"></textarea>
                                            </div>
                                        </div>
