                        ...
                        <!-- form start -->
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateSlide', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                ...
                                <div style="display: none" class="form-group categoryContent" @if($result['sliders'][0]->type!='category') style="display: none" @endif >
                                  <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Categories') }}</label>
                                  <div class="col-sm-10 col-md-4">
                                ...
                                <div style="display: none" class="form-group productContent" @if($result['sliders'][0]->type!='product') style="display: none" @endif>
