                                        ...
                                        @if($customerRewardPointCategories !== null)
                                            @foreach ($customerRewardPointCategories as $key=>$customerRewardPointCategory)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{ url('admin/customer_reward_point_category/edit')}}/{{$customerRewardPointCategory->id}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
