                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Selling Price</label>
                                                    <div class="col-sm-10 col-md-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input class="form-control" type="number" name="position_sequence" id="position_sequence" value="{{$result['product'][0]->position_sequence}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="image_alt_tag" class="col-sm-2 col-md-3 control-label">Image Alt Tag</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <input class="form-control" type="text" name="image_alt_tag" id="image_alt_tag" value="{{$result['product'][0]->image_alt_tag}}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
