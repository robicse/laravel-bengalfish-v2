                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control field-validate prodcust-type" name="products_type" onChange="prodcust_type();">
                                                            ...
                                                            <option value="0" selected >{{ trans('labels.Simple') }}</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input class="form-control" type="number" name="position_sequence" id="position_sequence" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <input class="form-control" type="text" name="image_alt_tag" id="image_alt_tag" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
