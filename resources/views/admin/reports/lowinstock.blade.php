                 ...
                 @if(count($result['lowQunatity']) > 0)
                    @foreach ($result['lowQunatity'] as  $key=>$lowQunatityProducts)
                        ...
                        <tr>
                            ...
                            <td><img src="{{asset($lowQunatityProducts->path)}}" alt="" width=" 100px" height="100px"></td>
                            <td width="45%">
                                <strong>{{ $lowQunatityProducts->products_name }} ( {{ $lowQunatityProducts->products_weight }} {{ $lowQunatityProducts->products_weight_unit }} )</strong><br>
                            </td>
                            <!--<td>
